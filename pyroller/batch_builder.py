...
from pyroller.batch_models import BatchTask, build_expected_outputs
...
class ManifestBatchBuilder:
    ...
    def build_tasks(self, request: PipelineRequest) -> list[BatchTask]:
        ...
        for index, entry in enumerate(entries, start=1):
            ...
            validate_pipeline_request(task.request, stages)
    ...
    def _load_entries(self) -> list[dict[str, Any]]:
        ...
        if isinstance(data, dict):
            ...
            if isinstance(tasks, list):
                return tasks
        raise ValueError(
            _("Manifest JSON/YAML must be either a top-level list of tasks or an object with a 'tasks' list. "
              "Example:\n"
              "tasks:\n"
              "  - id: song01\n"
